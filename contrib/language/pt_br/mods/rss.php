...
// ACP Feeds to Serve
	...
	'ACP_RSS_NEWS_EXPLAIN'				=> 'Mostrar a primera entrada dos fóruns com os seguintes ID\'s. Para selecionar mais de um fórum, separar ID\'s com virgulas, Exemplo: 1,2,5 <br />Deixar em branco para desativar o feed das Notícias. ',
...
// ACP General RSS Settings
	...
	'ACP_RSS_CHARACTERS_EXPLAIN'		=> 'Número de caracteres permitidos, recomendado 1000 characteres.<br />0 significa infinito, 1 significa sem texto',
	'ACP_RSS_CHARS'						=> 'Carateres',
	'ACP_RSS_ATTACHMENTS'				=> 'Anexos',
	'ACP_RSS_ATTACHMENTS_EXPLAIN'		=> 'Mostrar Anexos no feed',
	'ACP_RSS_IMAGE_SIZE'				=> 'Tamanho máximo das imagens em pixels',
	'ACP_RSS_IMAGE_SIZE_EXPLAIN'		=> 'Trocar o tamanho das imagens se for maior do que o configurado aqui.<br />0 significa sem trocar.<br />Propriedades do PHP getimagesize() <strong>Requerido</strong>',
	...
	'ACP_RSS_ITEMS_STATISTICS_EXPLAIN'	=> 'Será mostrado as Estatísticas de cada item <br />( Publicado por + data e hora + Respostas + Visitas )',
	...
	'ACP_RSS_EXCLUDE_ID_EXPLAIN'		=> 'Nos Feeds <strong>não aparecerão</strong> dados relacionados aos fóruns com estes ID\'s e nem dos seus subfóruns. Separar ID\'s com uma virgula, para selecionar mas de um fórum, Exemplo: 1,2,5 <br />Deixar em branco para mostrar dados de todos os fóruns.',
