...
// ACP General RSS Settings
	...
	'ACP_RSS_IMAGE_SIZE_EXPLAIN'		=> 'An image will be resized (as displayed in feeds) if it exceeds the specified width.<br /> 0 disables resizing.',
	...
	'ACP_RSS_BOARD_STATISTICS_EXPLAIN'	=> 'Displays The Board statistics in the first page of the overall board feed.',
	...
	'ACP_RSS_EXCLUDE_ID'				=> 'Exclude this Forums ID',
	'ACP_RSS_EXCLUDE_ID_EXPLAIN'		=> 'The RSS will <strong>not pull</strong> post from this forums ID\'s. Separate ID\'s by comma for multi-forums, eg. 1,2,5 <br />Leave blank to pull from all forums.',
