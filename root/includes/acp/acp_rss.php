...
* @version: $Id: acp_rss.php, v 1.2.0 2009/04/10 10:04:09 leviatan21 Exp $
...
class acp_rss
{
	...
	function main($id, $mode)
	{
		...
		$config['rss_newposts']				= ( isset($config['rss_newposts'])				) ? $config['rss_newposts']				: true;
		$config['rss_overall_forums']		= ( isset($config['rss_overall_forums'])		) ? $config['rss_overall_forums']		: true;
		$config['rss_overall_forums_limit']	= ( isset($config['rss_overall_forums_limit'])	) ? $config['rss_overall_forums_limit']	: 20;
		$config['rss_overall_threads']		= ( isset($config['rss_overall_threads'])		) ? $config['rss_overall_threads']		: true;
		$config['rss_overall_threads_limit']= ( isset($config['rss_overall_threads_limit'])	) ? $config['rss_overall_threads_limit']: 20;
		...
		$config['rss_egosearch_limit']		= ( isset($config['rss_egosearch_limit'])		) ? $config['rss_egosearch_limit']		: 20;
		...
		$config['rss_attach']				= ( isset($config['rss_attach'])				) ? $config['rss_attach']				: true;

		$config['rss_characters']			= ( isset($config['rss_characters'])			) ? $config['rss_characters']			: 0;
		...
		$config['rss_pagination_limit']		= ( isset($config['rss_pagination_limit'])		) ? $config['rss_pagination_limit']		: 10;
...
#			'lang'	=> 'mods/rss',
			'vars'	=> array(
				...
				'rss_limit'					=> array('lang' => 'ACP_RSS_LIMIT',					'validate' => 'int:5',	'type' => 'text:3:4',				'explain' => true, 'append' => ' ' . sprintf($user->lang['ACP_RSS_MIN'], 5) ),
				'rss_news_id'				=> array('lang' => 'ACP_RSS_NEWS',					'validate' => 'string',	'type' => 'text:0:255',				'explain' => true ),
				'rss_newposts'				=> array('lang' => 'ACP_RSS_NEWPOST',				'validate' => 'bool',	'type' => 'radio:enabled_disabled',	'explain' => true ),
				'rss_overall_forums'		=> array('lang'	=> 'ACP_RSS_OVERALL_FORUMS',		'validate' => 'bool',	'type' => 'radio:enabled_disabled',	'explain' => true ),
				'rss_overall_forums_limit'	=> array('lang' => 'ACP_RSS_OVERALL_FORUMS_LIMIT',	'validate' => 'int:5',	'type' => 'text:3:4',				'explain' => false, 'append' => ' ' . sprintf($user->lang['ACP_RSS_MIN'], 5) ),
				'rss_overall_threads'		=> array('lang' => 'ACP_RSS_OVERALL_THREAD',		'validate' => 'bool',	'type' => 'radio:enabled_disabled',	'explain' => true ),
				'rss_overall_threads_limit'	=> array('lang' => 'ACP_RSS_OVERALL_THREAD_LIMIT',	'validate' => 'int:5',	'type' => 'text:3:4',				'explain' => false, 'append' => ' ' . sprintf($user->lang['ACP_RSS_MIN'], 5) ),
				'rss_overall_posts'			=> array('lang' => 'ACP_RSS_OVERALL_POSTS',			'validate' => 'bool',	'type' => 'radio:enabled_disabled',	'explain' => true ),
				'rss_overall_posts_limit'	=> array('lang' => 'ACP_RSS_OVERALL_POSTS_LIMIT',	'validate' => 'int:5',	'type' => 'text:3:4',				'explain' => false, 'append' => ' ' . sprintf($user->lang['ACP_RSS_MIN'], 5) ),
				'rss_egosearch'				=> array('lang' => 'ACP_RSS_EGOSEARCH',				'validate' => 'bool',	'type' => 'radio:enabled_disabled',	'explain' => true ),
				'rss_egosearch_limit'		=> array('lang' => 'ACP_RSS_EGOSEARCH_LIMIT',		'validate' => 'int:5',	'type' => 'text:3:4',				'explain' => false, 'append' => ' ' . sprintf($user->lang['ACP_RSS_MIN'], 5) ),
				...
				'rss_attach'				=> array('lang' => 'ACP_RSS_ATTACH',				'validate' => 'bool',	'type' => 'radio:enabled_disabled',	'explain' => true ),
				...
				'rss_pagination_limit'		=> array('lang' => 'ACP_RSS_PAGINATION_LIMIT',		'validate' => 'int:5',	'type' => 'text:3:4',				'explain' => true, 'append' => ' ' . sprintf($user->lang['ACP_RSS_MIN'], 5) ),
