...
* @version: $Id: acp_rss.php, v 1.0.4 2008/08/18 18:08:08 leviatan21 Exp $
...
class acp_rss
{
	...
	function main($id, $mode)
	{
		...
		$display_vars = array(
			...
			'vars'	=> array(
				'legend1'				=> 'ACP_RSS_MANAGEMENT',
				'rss_enable'			=> array('lang' => 'ACP_RSS_ENABLE',		'validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => true),
				'rss_characters'		=> array('lang' => 'ACP_RSS_CHARACTERS',	'validate' => 'int:0',	'type' => 'text:3:4',		'explain' => true, 'append' => '  ' . $user->lang['ACP_RSS_CHARS']),
				'rss_limit'				=> array('lang' => 'ACP_RSS_LIMIT',			'validate' => 'int:10',	'type' => 'text:3:4',		'explain' => true,),
			//	not used yet
			//	'rss_image_size'		=> array('lang' => 'ACP_RSS_IMAGE_SIZE',	'validate' => 'int:0',	'type' => 'text:3:4',		'explain' => true, 'append' => ' px'),
				'rss_overall_forums'	=> array('lang'	=> 'ACP_RSS_OVERALL_FORUMS','validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => false),
				'rss_overall_threads'	=> array('lang' => 'ACP_RSS_OVERALL_THREAD','validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => false),
				'rss_overall_posts'		=> array('lang' => 'ACP_RSS_OVERALL_POSTS',	'validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => false),
				'rss_egosearch'			=> array('lang' => 'ACP_RSS_EGOSEARCH',		'validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => true),
				'rss_forum'				=> array('lang' => 'ACP_RSS_FORUM',			'validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => true),
				'rss_thread'			=> array('lang' => 'ACP_RSS_THREAD',		'validate' => 'bool',	'type' => 'radio:yes_no',	'explain' => true)
			)
		);
